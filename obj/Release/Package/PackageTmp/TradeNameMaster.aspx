<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCompany.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="TradeNameMaster.aspx.cs" Inherits="Production_Costing_Software.TradeNameMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <script type="text/javascript">
         ...
         var GridId = "<%=GridTradeNameList.ClientID %>";
                                    ...
                                    <div class="container ">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12  col-lg-6 offset-3">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <asp:TextBox ID="TradeNametxt" OnTextChanged="TradeNametxt_TextChanged" AutoPostBack="true"  class="form-control " type="text" runat="server"></asp:TextBox>
                                        ...
                                        <div class="row  justify-content-center align-items-center mt-4">
                                            ...
                                            <div class="col-10 col-lg-4 col-lg-4">
                                                <div class="d-grid">
                                                    <asp:Button ID="UpdateTradeName" Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" OnClick="UpdateTradeName_Click" Visible="false" runat="server" Text="Update" class="btn btn-success btn-block " />
                                                    <asp:Button ID="AddTradeName" Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" OnClick="AddTradeName_Click" runat="server" Text="Submit" class="btn btn-primary btn-block " />
                                                </div>
                                            </div>
                                            <div class="col-10 col-lg-4 col-lg-4">
                                                <div class="d-grid">
                                                    <asp:Button ID="CancelTradeName" Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" OnClick="CancelTradeName_Click" runat="server" Text="Cancel" class="btn btn-primary btn-warning " />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <asp:GridView ID="GridTradeNameList" CssClass=" table-hover table-responsive gridview"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:Button ID="Delete" Visible='<%# lblCanDelete.Text=="True"?true:false %>' OnClientClick="return confirm('Are you sure you want to delete this item?');" Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" ValidationGroup="Delete" OnClick="Delete_Click1" runat="server" class="btn btn-danger btn-sm" Text="Delete" />
                                                    <asp:Button ID="Edit" Visible='<%# lblCanEdit.Text=="True"?true:false %>' Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" ValidationGroup="Edit" OnClick="Edit_Click1" runat="server" class="btn btn-success btn-sm" Text="Edit" />
                                                </ItemTemplate>
