<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="PriceList_GP_Actual.aspx.cs" Inherits="Production_Costing_Software.PriceList_GP_Actual" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="container-fluid px-4" style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)">
                            <h1 class="mt-4">PriceList GP Actual</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="PriceList_GP.aspx">PriceList GP Actual
                                </a></li>
                            </ol>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <asp:TextBox ID="CreatePriceListtxt" CssClass="form-control" OnTextChanged="CreatePriceListtxt_TextChanged"  AutoPostBack="true" Width="200px" runat="server"></asp:TextBox>
                                        <asp:Button ID="btnEditing" runat="server" Text="Edit" CssClass="btn btn-dark float-md-end" OnClick="btnEditing_Click" />
                                    </div>
                                    <div class="align-content-end">
                                        <asp:Button ID="PdfReport" OnClick="PdfReport_Click" Style="border-radius: 5px; box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.4)" Text="Pdf Report" runat="server" class="btn btn-danger  float-end  float-end" />
                                    </div>
                                </div>
                                ...
                                <div class="card-body" style="overflow: auto">
                                    ...
                                    <asp:GridView ID="Grid_PriceList_GP_Actual" CssClass=" table-hover table-responsive gridview"
                                        OnRowCreated="Grid_PriceList_GP_Actual_RowCreated" EnableViewState="true"
                                        GridLines="None" Style="border-radius: 5px; box-shadow: 5px 17px 10px -10px rgba(0, 0, 0, 0.4);"
                                        PagerStyle-CssClass="gridview_pager" OnRowDataBound="Grid_PriceList_GP_Actual_RowDataBound"
