<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PriceList_GP_ActualEstimate.aspx.cs" Inherits="Production_Costing_Software.PriceList_GP_ActualEstimate" %>
                                    ...
                                    <div class="card-body" style="overflow: auto;">
                                        ...
                                        <asp:GridView ID="Grid_PriceList_GP_ActualEstimate" CssClass=" table-hover table-responsive gridview"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="TOD" ControlStyle-Width="130px">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TODtxt"
                                                            onchange="calculaterate('0',this.id,0);"
                                                            CssClass="form-control" Text='<%#Eval("TOD") %>' TextMode="Number" runat="server"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function updatecalc_actual(mainid, lblindexid, grd, tp) {
            ...
            if (tp == '1') {
                ...
                var newsuggprice = parseFloat(document.getElementById(grd + "_SuggestedPriceWithPDttxt_lbl_" + t).innerHTML) - rplestprice - parseFloat(pd.value) - parseFloat(qd.value) - parseFloat(tod.value);
        ...
        function updatecalc(mainid, lblindexid, grd, tp) {
            ...
            if (tp == '1') {
                ...
                var newsuggprice_sub = parseFloat(document.getElementById(grd + "_SuggestedPriceWithPDttxt_lbl_" + t1).innerHTML) - rplestprice_sub - parseFloat(pd.value) - parseFloat(qd.value) - parseFloat(tod.value);
