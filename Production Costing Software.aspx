<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Production Costing Software.aspx.cs" Inherits="Production_Costing_Software.Production_Costing_Software" %>
...
<body class="sb-nav-fixed">
    ...
    <div class="container-fluid">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-1" href="index.html">Product Costing Software</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
        <%--    <form id="form1" runat="server" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer">
                    <div class="small">Product Costing Software</div>
                    Project
