...
{
    public partial class PriceList_GP_ActualEstimateOld : System.Web.UI.Page
    {
        int User_Id;
        int Company_Id;
        ...
        protected void Grid_PriceList_GP_ActualEstimate_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            for (int rowIndex = Grid_PriceList_GP_ActualEstimate.Rows.Count - 2; rowIndex >= 0; rowIndex--)
            {
                ...
                if (lblPrevFinalNRV.Text == lblFinalNRV.Text)
                {
                    if (gvPreviousRow.Cells[10].RowSpan < 2)
                    {
                        gvRow.Cells[10].RowSpan = 2;
                    }
                    else
                    {
                        gvRow.Cells[10].RowSpan = gvPreviousRow.Cells[10].RowSpan + 1;
                    }
                    gvPreviousRow.Cells[10].Visible = false;
                }
                if (lblPrevFinalNRV.Text == lblFinalNRV.Text)
                {
                ...
                if (lblPrevFinalNRV.Text == lblFinalNRV.Text)
                {
                    gvRow.Cells[16].BackColor = System.Drawing.Color.LightGreen;
                    ...
                    {
                        gvRow.Cells[16].RowSpan = gvPreviousRow.Cells[15].RowSpan + 1;
                    }
