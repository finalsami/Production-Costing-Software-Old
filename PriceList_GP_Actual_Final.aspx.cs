...
namespace Production_Costing_Software
{
    ...
    public partial class PriceList_GP_Actual_Final : System.Web.UI.Page
    {
        int User_Id;
        int Company_Id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //lblPMRM_Category_Id.Text = Session["PMRM_Catgeory_Id"].ToString();
        ...
        public void Grid_PriceListGP_ActualData()
        {
            ...
            ClsPriceList_GP cls1 = new ClsPriceList_GP();
            //dt1 = cls1.GetPriceList_GP_Actual_Final(Company_Id.ToString());
            //Grid_PriceList_GP_Actual.DataSource = dt1;
            ...
            dt = cls.Get_PriceListALL_GP_ActualByBPM(Company_Id.ToString(), Convert.ToInt32(lblBPM_Id.Text), Convert.ToInt32(lblPMRM_Category_Id.Text));
            if (dt.Rows.Count > 0)
            {
                lblBulkProductName.Text = dt.Rows[0]["BPM_Product_Name"].ToString();

                Grid_Default_PriceList_GP_Actual.DataSource = dt;
            ...
            //    (row1.FindControl("lblFk_State_Id") as Label).Text)
            //}
        }
        ...
        public void GetUserRights()
        {
            ...
            int GroupId = Convert.ToInt32(dtMenuList.Rows[38]["GroupId"]);
            lblCanDelete.Text = Convert.ToBoolean(dtMenuList.Rows[38]["CanDelete"]).ToString();
            lblCanEdit.Text = Convert.ToBoolean(dtMenuList.Rows[38]["CanEdit"]).ToString();
            if (Convert.ToBoolean(dtMenuList.Rows[38]["CanEdit"]) == true)
            {
        ...
        protected void DisplayView()
        {
            ...
            if (Convert.ToBoolean(dtMenuList.Rows[34]["CanEdit"]) == true)
            {
        ...
        protected void GridAddPriceGP_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/PriceList_GP_Actual.aspx");
        }
        ...
        {
            foreach (GridViewRow row in Grid_Default_PriceList_GP_Actual.Rows)
            {
                bool CheckBoxChanged = (row.FindControl("CheckBox_Check") as CheckBox).Checked;
            }
        }
        ...
        protected void PdfReport_Click(object sender, EventArgs e)
        {
            using (StringWriter sw = new StringWriter())
            {
                ...
                Grid_Default_PriceList_GP_Actual.HeaderRow.Style.Add("width", "10%");
                Grid_Default_PriceList_GP_Actual.HeaderRow.Style.Add("font-size", "12px");
                Grid_Default_PriceList_GP_Actual.Style.Add("text-decoration", "none");
                Grid_Default_PriceList_GP_Actual.Style.Add("font-family", "Arial, Helvetica, sans-serif;");
                Grid_Default_PriceList_GP_Actual.Style.Add("font-size", "10px");
                ...
                foreach (GridViewRow row in Grid_Default_PriceList_GP_Actual.Rows)
                {
                    ...
                    {
                        cell.BackColor = Grid_Default_PriceList_GP_Actual.RowStyle.BackColor;
                ...
                Grid_Default_PriceList_GP_Actual.RenderControl(hw);
