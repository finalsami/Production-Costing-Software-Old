...
{
    public partial class EstimatePriceListOld : System.Web.UI.Page
    {
        int User_Id;
        int Company_Id;
        string Status = "";
                ...
                for (int j = 0; j < row.Cells.Count; j++)
                {
                    ...
                    foreach (GridViewRow row2 in Grid_EstimatePricelistStatusWise.Rows)
                    {
                        ...
                        if ((row2.FindControl("lblStatus") as Label).Text == "Estimate")
                        {
                            ...
                            (row2.FindControl("TotalBtxt") as TextBox).Enabled = false;
                            (row2.FindControl("Totaltxt") as TextBox).Enabled = false;
                            (row2.FindControl("SuggestedFinalTotalCosttxt") as TextBox).Enabled = true;
                            (row2.FindControl("FinalProfit_Amttxt") as Label).Enabled = true;
                            (row2.FindControl("FinalProfit_Percenttxt") as TextBox).Enabled = true;
                            (row2.FindControl("FinalPriceLtrKgtxt") as TextBox).Enabled = true;
                            (row2.FindControl("FinalProfitAmount_Percent_Ltr_Kg_Amttxt") as Label).Enabled = true;
                            (row2.FindControl("FinalProfitAmount_Percent_Ltr_Kg_Pertxt") as TextBox).Enabled = true;
                        }
